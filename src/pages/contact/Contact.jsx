import img1 from "../../assets/imgs/page/contact-2.png";
                ...
                <section className="mb-50">
                  <div className="row mb-60">
                    <div className="col-md-4 mb-4 mb-md-0">
                      ...
                      205 North Michigan Avenue, Suite 810<br></br>
                      Chicago, 60601, USA<br></br>
                      <abbr title="Phone">Phone:</abbr> (123) 456-7890<br></br>
