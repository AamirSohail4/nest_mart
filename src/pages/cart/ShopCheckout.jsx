...
import img4 from "../../assets/imgs/theme/icons/payment-paypal.svg";
import img5 from "../../assets/imgs/theme/icons/payment-visa.svg";
import img6 from "../../assets/imgs/theme/icons/payment-master.svg";
import img7 from "../../assets/imgs/theme/icons/payment-zapper.svg";
                        ...
                        >
                          <span className="selection">
                            <span
                              ...
                              aria-expanded="false"
                              tabIndex="0"
                              aria-labelledby="select2-87hu-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-87hu-container"
                                role="textbox"
                                aria-readonly="true"
                            ...
                            >
                              <span className="selection">
                                <span
                                  ...
                                  aria-expanded="false"
                                  tabIndex="0"
                                  aria-labelledby="select2-ji7s-container"
                                >
                                  <span
                                    className="select2-selection__rendered"
                                    id="select2-ji7s-container"
                                    role="textbox"
                                    aria-readonly="true"
                                    title="Select an option..."
                                  >
            ...
            <div className="col-lg-5">
              ...
              <div className="payment ml-30">
                ...
                <div className="payment-logo d-flex">
                  <img className="mr-15" src={img4} alt="" />
                  <img className="mr-15" src={img5} alt="" />
                  <img className="mr-15" src={img6} alt="" />
                  <img src={img7} alt="" />
                </div>
